...
import { DEFAULT_MESSAGES } from '@/lib/types';
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm">Stripe, SMS e mensagens personalizadas</p>
      </div>
      ...
      <form onSubmit={handleSave} className="max-w-2xl space-y-8">
        ...
        <div className="bg-[#111] border border-[#222] rounded-2xl p-6">
          ...
          <p className="text-gray-500 text-xs mb-5">
            Personalize as mensagens SMS enviadas em cada etapa. Use: {'{nome}'}, {'{id}'}, {'{rastreio}'}, {'{total}'}
          </p>
          ...
          <button
            type="button"
            onClick={() =>
              setSettings({ ...settings, messages: { ...DEFAULT_MESSAGES } })
            }
